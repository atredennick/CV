...
\begin{resume}
   ...
   %__________________________________________________________________________________________________________________
    ...
    \section{\mysidestyle Publications\\ \textsl{\footnotesize in press}\\ \textsl{\footnotesize and published}}     
     	\textbf{Tredennick, A.T.}, Hanan, N.P. In Press. Effects of tree harvest on the stable-state dynamics of savanna and forest. \textsl{The American Naturalist} (open access) \vspace{-6mm} \\%
