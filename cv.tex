...
\begin{resume}
   ...
   Rice, J., \textbf{A.T. Tredennick}, and L. Joyce. (2011). The climate of the Shoshone National Forest: A synthesis of past changes, future projections, and 			ecosystem implications. USDA National Forest Service General Technical Report 264. \vspace{-6mm}\\%
	...
	Wilcox*, K.R., \textbf{A.T. Tredennick}*, S.E. Koerner, E. Grman, L.M. Hallett, M.L. Avolio, K.J. La Pierre, G.R. Houseman, F. Isbell, D.S. Johnson, \emph{et al.}. Asynchrony among local communities stabilizes ecosystem function of metacommunities. In revision at \emph{Ecology Letters}. \\%
    ...
    %\textbf{Pending}: ``Synthesizing time series of plant and animal populations to understand the limits to ecological forecasts'', USGS Powell Center Working Group Proposal.\vspace{2mm}\\
...
%__________________________________________________________________________________________________________________
   ...
   % \section{\mysidestyle Presentations}
    ...
    Tredennick, A.T., Hanan, N.P., Bucini, G., and Parton, W. (2013) ``Sustainability and Biome-Level Impacts of Fuelwood Harvesting in sub-Saharan Africa,'' \textbf{Invited Seminar}, Geospatial Science Center of Excellence, South Dakota State University. \vspace{-6mm}\\%
